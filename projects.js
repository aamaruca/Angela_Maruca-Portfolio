const projects = [
  {
    ...
    description: "Built with Javascript, CSS and HTML The Sssavvy Sssipper consumes a third party API. It is an app for users to find recipes and ingredients for cocktails. ",
